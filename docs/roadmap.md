...
| **5** | Parquet + HTTP (bearer/basic/**OAuth2 client_credentials**, JSON, pagination) + **PostgreSQL** (`query` or **table/schema**), **dispatcher** | **Partial** — HMAC / streaming, more DBs **planned** |
